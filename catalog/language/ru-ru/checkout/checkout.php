...
$_['heading_title_text']                  = 'Оформление заказа';
// Text
...
$_['text_checkout_payment_method']   = 'Выберите способ оплаты';
...
$_['column_price']                   = 'Цена';
$_['column_total']                   = 'Итоговая стоимость';
...
$_['entry_shipping']                 = 'Использовать данный адрес для выставления счетов';
...
$_['contact']                        = 'Контакты получателя';
$_['order']                          = 'Заказать';
$_['fullname']                       = 'Ф.И.О';
$_['text_empty']                     = 'Корзина пуста!';
$_['bank_transfer_text']             = 'Вы можете провести оплату перечислением связавшись с нашими операторами при оформлении заказа.';
$_['chrono_text']                    = 'Мы являемся проверенным дилером Chrono24. Вы можете оплатить покупку через Chrono24. (Сайт автоматически переведет вас на страницу оплаты после завершения заказа).';
$_['cash_text']             = 'Часы можно оплатить наличными в бутиках по адресу : Смоленская пл., 1А, Москва, Россия, 121099.';
$_['confirm_text']          = 'Оформить заказ';
$_['guest_order']           = 'Продолжить как гость';
$_['option_create_account'] = 'У вас будет возможность создать учетную запись.';
$_['guarantee']             = 'ГАРАНТИИ ПРЕДОСТАВЛЯЕМЫЕ TIMPOGRAM';
$_['info_text_1']           = 'Вся продукция предоставленная в каталоге на 100% подлинная';
$_['info_text_2']           = 'Гарантия на все часы';
$_['info_text_3']           = 'Более 1 Миллиона Довольных Клиентов';