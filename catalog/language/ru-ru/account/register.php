...
$_['text_account_already'] = '<p>Есть аккаунт?</p> <a href="%s">Войти</a>'; 
$_['text_your_details']    = 'Основные данные';
$_['text_newsletter']      = 'Рассылка новостей';
$_['text_your_password']   = 'Ваш пароль';
$_['text_agree']           = 'Регистрируясь, вы принимаете наши Условия, Политику использования данных и Политику в отношении файлов cookie.';
...
$_['success_message']      = 'Вы успешно зарегистрировались.';
