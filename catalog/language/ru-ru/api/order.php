...
$_['error_fullname']         = 'Полное имя не может быть пустым.';
$_['error_phone']            = 'Телефон не может быть пустым.';
$_['error_email']            = 'Электронной почты не может быть пустым.';
$_['error_message']          = 'Сообщение не может быть пустым.';
$_['success_order']          = 'Заказ успешно оформлен';
$_['error_offer']            = 'Вы не можете предложить цену когда в корзине более 1 продукта.';
