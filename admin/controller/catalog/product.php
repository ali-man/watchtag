...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['with_order'])) {
			$data['with_order'] = $this->request->post['with_order'];
		} elseif (!empty($product_info)) {
			$data['with_order'] = $product_info['with_order'];
		} else {
			$data['with_order'] = 0;
		}

		if (isset($this->request->post['with_order_url'])) {
			$data['with_order_url'] = $this->request->post['with_order_url'];
		} elseif (!empty($product_info)) {
			$data['with_order_url'] = $product_info['with_order_url'];
		} else {
			$data['with_order_url'] = '';
		}
